...
def display_objects(details):
    ...
    for i in range(185,500,30):
        objects.append(canvas.create_text(325.0,i,anchor="w",text=details[(i-155)//30],fill="#FFFFFF",font=("Inter", 20 * -1)))
    objects.append(canvas.create_text(525.0,425,anchor="w",text=details[12],fill="#FFFFFF",font=("Inter", 20 * -1)))
    objects.append(canvas.create_text(525.0,455,anchor="w",text=details[13],fill="#FFFFFF",font=("Inter", 20 * -1)))    
...
def submit_response():
    destory_objects()
    try:
        with time_limit(MAX_TIME_LIMITER):
            packet_sniffer()
    except:
        print("except blcok")
        canvas.create_text(325.0,140,anchor="w",text="Time limit exceeded",fill="#FFFFFF",font=("Inter", 27 * -1))
...
button_image_6=Image.open(relative_to_assets("image_1.png"))
...
button_image_7=Image.open(relative_to_assets("image_1.png"))
...
button_image_8=Image.open(relative_to_assets("image_1.png"))
